package ru.isshepelev.jwt.configuration;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers("/user/**").hasAnyRole(Role.SUPER_USER.name(), Role.ADMIN.name(), Role.USER.name())
                .antMatchers("/super-user/**").hasAnyRole(Role.SUPER_USER.name(), Role.ADMIN.name())
